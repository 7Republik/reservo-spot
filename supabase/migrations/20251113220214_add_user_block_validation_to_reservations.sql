-- Actualizar función de validación de reservas para verificar bloqueos activos
...
COMMENT ON FUNCTION public.validate_parking_spot_reservation IS 
  'Valida si un usuario puede reservar una plaza. Incluye verificación de bloqueos activos, permisos, fechas y disponibilidad.';
