-- =====================================================
-- FIX: Orden de operaciones en accept_waitlist_offer
-- =====================================================
-- La función elimina las entradas de waitlist ANTES de
-- insertar en waitlist_logs, causando violación de FK.
-- Solución: Registrar en logs ANTES de eliminar entradas.
-- =====================================================
...
BEGIN
  ...
  -- 8. Registrar en logs ANTES de eliminar entradas
  -- FIX: Mover este paso antes del DELETE
  ...
  -- 9. Eliminar todas las entradas de lista de espera del usuario
...
'Acepta una oferta de lista de espera y crea una reserva confirmada. FIXED: Registra en logs antes de eliminar entradas.';
