-- =====================================================
-- BLOQUEAR RESERVAS DIRECTAS CUANDO HAY WAITLIST ACTIVA
-- =====================================================
-- Si hay usuarios en la lista de espera para un grupo/fecha,
-- nadie puede reservar directamente. La plaza debe ofrecerse
-- primero a quien está en la lista.
-- =====================================================
...
BEGIN
  ...
  -- =====================================================
  -- NUEVA VALIDACIÓN 2.5: Verificar lista de espera activa
  -- =====================================================
  -- Si la waitlist está habilitada y hay usuarios esperando,
  -- bloquear reservas directas
  ...
  IF v_waitlist_enabled THEN
    -- Verificar si hay usuarios en lista de espera para este grupo/fecha
    SELECT EXISTS (
      SELECT 1 
...
COMMENT ON FUNCTION validate_parking_spot_reservation IS 
  'Valida si un usuario puede reservar una plaza. Incluye verificación de bloqueos, waitlist activa, permisos, fechas y disponibilidad.';
