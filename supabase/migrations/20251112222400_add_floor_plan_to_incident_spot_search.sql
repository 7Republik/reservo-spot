-- Migration: Add floor_plan_url to incident spot search
-- This migration updates the find_available_spot_for_incident function to:
-- Return the floor_plan_url from parking_groups so the UI can display the visual map
...
-- ============================================================================
-- Create improved function with floor_plan_url
-- ============================================================================
...
Returns spot details including floor_plan_url for visual map display.
