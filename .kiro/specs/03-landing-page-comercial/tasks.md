...
- [ ] 1.3 Preparar assets necesarios (screenshots, logos)
  - Crear carpeta `src/assets/landing/`
  - Tomar screenshots del dashboard, calendario, check-in
  - Optimizar imágenes (WebP, compresión)
  - _Requirements: 1, 3, 14_

- [ ] 2. Generar HeroSection con 21st.dev MCP
- [ ] 2.1 Usar MCP para generar HeroSection moderna
...
- [ ] 2.2 Integrar HeroSection generado en `src/components/landing/HeroSection.tsx`
...
- [ ] 2.3 Añadir imagen/screenshot del dashboard al hero
  - Integrar imagen desde assets
  - Configurar responsive (ocultar en mobile si necesario)
  - _Requirements: 1_

- [ ] 3. Generar ProblemsSection con 21st.dev MCP
- [ ] 3.1 Usar MCP para generar sección de problemas
...
- [ ] 3.2 Integrar ProblemsSection en `src/components/landing/ProblemsSection.tsx`
  - Copiar código generado
  - Adaptar con iconos de Lucide React
  - Conectar con landingContent.ts
  - _Requirements: 2_

- [ ] 4. Implementar SolutionsSection (layout alternado)
- [ ] 4.1 Crear componente base `src/components/landing/SolutionsSection.tsx`
  - Layout alternado (imagen izquierda/derecha)
  - 8 subsecciones para funcionalidades
  - Responsive (stack en mobile)
  - _Requirements: 3_

- [ ] 4.2 Generar cards de solución con 21st.dev MCP
...
- [ ] 4.3 Añadir screenshots de cada funcionalidad
  - Integrar imágenes desde assets
  - Configurar posición alternada
  - _Requirements: 3_

- [ ] 5. Implementar FeaturesDetailSection (tabs o accordion)
- [ ] 5.1 Decidir entre tabs o accordion según diseño
  - Evaluar mejor UX para 6 módulos
  - Implementar componente base
  - _Requirements: 4_

- [ ] 5.2 Generar estructura con 21st.dev MCP
...
- [ ] 5.3 Integrar en `src/components/landing/FeaturesDetailSection.tsx`
  - Copiar código generado
  - Añadir badges ("Nuevo", "Popular")
  - Conectar con landingContent.ts
  - _Requirements: 4_

- [ ] 6. Generar BenefitsByRoleSection con 21st.dev MCP
- [ ] 6.1 Usar MCP para generar sección de beneficios por rol
  - Ejecutar prompt: `/cui Create benefits section with 3 columns for user roles`
  - 3 columnas (Empleados, Admins, Directores)
  - Colores diferenciados
  - _Requirements: 5_

- [ ] 6.2 Integrar en `src/components/landing/BenefitsByRoleSection.tsx`
  - Copiar código generado
  - Añadir quotes representativos
  - Conectar con landingContent.ts
  - _Requirements: 5_

- [ ] 7. Generar KeyBenefitsSection con 21st.dev MCP
- [ ] 7.1 Usar MCP para generar sección de beneficios clave
  - Ejecutar prompt: `/cui Create benefits section with 4 large cards`
  - 4 beneficios verificables
  - Iconos animados en hover
  - _Requirements: 6_

- [ ] 7.2 Integrar en `src/components/landing/KeyBenefitsSection.tsx`
  - Copiar código generado
  - Configurar iconos de Lucide React
  - Conectar con landingContent.ts
  - _Requirements: 6_

- [ ] 8. Generar UseCasesSection con 21st.dev MCP
- [ ] 8.1 Usar MCP para generar sección de casos de uso
  - Ejecutar prompt: `/cui Create use cases section with 4 cards`
  - 4 industrias (Oficinas, Hospitales, Universidades, Retail)
  - Iconos representativos
  - _Requirements: 7_

- [ ] 8.2 Integrar en `src/components/landing/UseCasesSection.tsx`
  - Copiar código generado
  - Conectar con landingContent.ts
  - _Requirements: 7_

- [ ] 9. Implementar ComparisonSection (tabla)
- [ ] 9.1 Generar tabla de comparación con 21st.dev MCP
  - Ejecutar prompt: `/cui Create comparison table Manual vs RESERVEO`
  - 6 filas de comparación
  - Iconos X y checkmarks
  - _Requirements: 8_

- [ ] 9.2 Integrar en `src/components/landing/ComparisonSection.tsx`
  - Copiar código generado
  - Configurar colores contrastantes
  - Conectar con landingContent.ts
  - _Requirements: 8_

- [ ] 10. Implementar TechnologySection
- [ ] 10.1 Crear componente `src/components/landing/TechnologySection.tsx`
  - Grid de logos de tecnologías
  - Lista de características de seguridad
  - Layout en 2 subsecciones
  - _Requirements: 9_

- [ ] 10.2 Añadir logos de tecnologías
  - React, TypeScript, Supabase, Vercel, Tailwind
  - Usar logos oficiales o buscar con 21st.dev logo search
  - _Requirements: 9_

- [ ] 11. Generar PricingSection con 21st.dev MCP
- [ ] 11.1 Usar MCP para generar sección de pricing
...
- [ ] 11.2 Integrar en `src/components/landing/PricingSection.tsx`
  - Copiar código generado
  - Conectar con landingContent.ts
  - _Requirements: 10_

- [ ] 12. Implementar FAQSection (accordion)
- [ ] 12.1 Generar accordion con 21st.dev MCP
  - Ejecutar prompt: `/cui Create FAQ section with accordion`
  - 8 preguntas frecuentes
  - Solo una expandida a la vez
  - _Requirements: 11_

- [ ] 12.2 Integrar en `src/components/landing/FAQSection.tsx`
  - Copiar código generado
  - Configurar lógica de accordion
  - Conectar con landingContent.ts
  - _Requirements: 11_

- [ ] 13. Generar FinalCTASection con 21st.dev MCP
- [ ] 13.1 Usar MCP para generar CTA final potente
...
- [ ] 13.2 Integrar en `src/components/landing/FinalCTASection.tsx`
  - Copiar código generado
  - Configurar navegación de CTAs
...
- [ ] 14. Mejorar Footer
- [ ] 14.1 Actualizar `src/components/landing/Footer.tsx`
...
- [ ] 14.2 Configurar links del footer
  - Crear páginas placeholder si necesario
  - Configurar navegación
  - _Requirements: 13_

- [ ] 15. Integrar todos los componentes en Index.tsx
- [ ] 15.1 Actualizar `src/pages/Index.tsx` con nueva estructura
  - Importar todos los componentes de landing
  - Ordenar secciones según diseño
  - Pasar props desde landingContent.ts
  - _Requirements: 1-13_

- [ ] 15.2 Configurar scroll suave entre secciones
  - Añadir IDs a secciones
  - Configurar navegación con scroll suave
  - _Requirements: 15_

- [ ] 16. Añadir animaciones y microinteracciones
- [ ] 16.1 Implementar animaciones de scroll (fade-in, slide-in)
  - Usar Intersection Observer o librería (framer-motion)
  - Animar elementos al entrar en viewport
  - _Requirements: 15_

- [ ] 16.2 Añadir hover effects en cards y botones
  - Transiciones suaves
  - Elevación en hover
  - _Requirements: 15_

- [ ] 16.3 Respetar prefers-reduced-motion
  - Detectar preferencia del usuario
  - Desactivar animaciones si necesario
  - _Requirements: 15_

- [ ] 17. Optimizar responsive design
- [ ] 17.1 Verificar y ajustar responsive en mobile
  - Probar en diferentes tamaños (320px, 375px, 414px)
  - Ajustar grids y layouts
  - _Requirements: 14_

- [ ] 17.2 Verificar y ajustar responsive en tablet
  - Probar en 768px, 1024px
  - Ajustar columnas y espaciados
  - _Requirements: 14_

- [ ] 17.3 Optimizar para desktop grande
  - Probar en 1440px, 1920px
  - Limitar ancho máximo de contenido
  - _Requirements: 14_

- [ ] 18. Implementar SEO y meta tags
- [ ] 18.1 Añadir meta tags en `index.html` o componente Head
  - Title, description, keywords
  - Open Graph tags
  - Twitter Card tags
  - _Requirements: 14_

- [ ] 18.2 Añadir structured data (JSON-LD)
  - Schema.org para SoftwareApplication
  - Incluir en head del documento
  - _Requirements: 14_

- [ ] 18.3 Verificar headings semánticos
  - Un solo H1 (en hero)
  - H2 para títulos de sección
  - H3 para subtítulos
  - _Requirements: 14_

- [ ] 18.4 Añadir alt text a todas las imágenes
