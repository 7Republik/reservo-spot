...
- [x] 2. Implementar servicio de monitoreo de conexión
  ...
  - Implementar lógica de 3 fallos consecutivos antes de entrar en modo offline
  - Implementar validación de servidor antes de salir del modo offline
...
- [x] 7. Modificar useParkingCalendar para soporte offline
  ...
  - Implementar fallback a cache con reintentos automáticos si falla la carga online
  - Envolver botones de acción con `DisabledControlTooltip`
...
- [ ] 16. Adaptar componentes de check-in para modo offline
  ...
  - Envolver controles con `DisabledControlTooltip`
  - Mantener visualización de estado actual de check-in desde cache (solo lectura)
  - _Requisitos: 5.1, 5.4, 7.1_

- [ ]* 17. Crear tests unitarios para servicios offline
...
- [ ]* 18. Crear tests de integración para flujos offline
...
- [ ]* 19. Crear tests E2E para escenarios de usuario
...
- [ ]* 21. Documentar API y patrones de uso
